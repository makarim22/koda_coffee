...
const menuData = {
  espresso: [
    { id: 'e1', title: 'Signature Blend', origin: 'Colombia & Ethiopia', process: 'Washed', price: '$4.00', desc: 'Our flagship daily rider. Notes of dark chocolate, toasted hazelnut, and dark cherry with a creamy mouthfeel.', img: 'https://images.unsplash.com/photo-1585490499691-1c390508ea78?auto=format&fit=crop&q=80&w=800', delay: 'delay-100' },
    { id: 'e2', title: 'Finca El Paraiso', origin: 'Colombia', process: 'Thermal Shock', price: '$5.50', desc: 'An experimental masterpiece. Passionfruit, lychee, and a bright, syrupy and highly acidic mouthfeel.', img: 'https://images.unsplash.com/photo-1514432324607-a2ce7beea848?auto=format&fit=crop&q=80&w=800', delay: 'delay-200' },
    { id: 'e3', title: 'Ethiopia Guji Natural', origin: 'Ethiopia', process: 'Natural', price: '$5.00', desc: 'Wild and fruit-forward. Explodes with strawberry jam, ripe peach, and fragrant floral aromatics.', img: 'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&q=80&w=800', delay: 'delay-300' },
    { id: 'e4', title: 'Colombia Decaf', origin: 'Colombia', process: 'Sugarcane Decaf', price: '$4.50', desc: 'Decaffeinated naturally using sugarcane process. Notes of brown sugar, red apple, and graham cracker.', img: 'https://images.unsplash.com/photo-1541167760496-1628856ab772?auto=format&fit=crop&q=80&w=800', delay: 'delay-100' },
  ],
  pourOver: [
    ...
    { id: 'p3', title: 'Panama Geisha', origin: 'Panama', process: 'Washed', price: '$12.00', desc: 'The crown jewel of coffee. Delicate bergamot, jasmine, and complex tropical fruits. Farm-direct reserve.', img: 'https://images.unsplash.com/photo-1511920170033-f8396924c348?auto=format&fit=crop&q=80&w=800', delay: 'delay-300' },
  ...
  pastries: [
    { id: 'pa1', title: 'Almond Croissant', origin: 'House Baked', process: 'Viennoiserie', price: '$4.75', desc: 'Twice baked, filled with house frangipane, hand-laminated pastry layers, and topped with toasted almonds.', img: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&q=80&w=800', delay: 'delay-100' },
